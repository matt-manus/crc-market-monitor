...
console.log(JSON.stringify({ target, types, exchanges, samples: Object.fromEntries(Object.entries(latestByType).map(([type, tickers]) => [type, tickers.slice(0, 15)])) }, null, 2));
